...
### Live dev/prod status — auto-refreshed 2026-06-19 07:52Z
...
| `phala/glm-4.7-flash` | `dstack-nvidia-0.5.9-806a352e` | prod |
| `phala/glm-5` | `opaque (MRTD only)` | — |
| `phala/glm-5.1` | `opaque (MRTD only)` | — |
| `phala/glm-5.2` | `dstack-nvidia-dev-0.5.9-0e09f2bc` | **DEV** |
| `phala/gpt-oss-120b` | `dstack-nvidia-0.5.5` | prod |
...
| `phala/qwen2.5-vl-72b-instruct` | `opaque (MRTD only)` | — |
| `phala/qwen3-30b-a3b-instruct-2507` | `dstack-nvidia-0.5.5` | prod |
| `phala/qwen3-vl-30b-a3b-instruct` | `opaque (MRTD only)` | — |
| `phala/qwen3.5-27b` | `dstack-nvidia-0.5.9-806a352e` | prod |
| `phala/qwen3.5-397b-a17b` | `opaque (MRTD only)` | — |
| `phala/qwen3.6-27b` | `opaque (MRTD only)` | — |
| `phala/qwen3.6-35b-a3b` | `dstack-nvidia-0.5.5` | prod |
| `phala/qwen3.6-35b-a3b-uncensored` | `dstack-nvidia-dev-0.5.9-0e09f2bc` | **DEV** |
