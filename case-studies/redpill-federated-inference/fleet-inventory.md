...
### Live dev/prod status — auto-refreshed 2026-07-19 06:51Z
...
| `phala/gemma-3-27b-it` | `dstack-nvidia-0.5.9-806a352e` | prod |
| `phala/gemma-4-26b-a4b-uncensored` | `dstack-nvidia-0.5.9-806a352e` | prod |
| `phala/gemma-4-31b-it` | `dstack-nvidia-0.5.9-806a352e` | prod |
...
| `phala/qwen3.6-35b-a3b-uncensored` | `dstack-nvidia-0.5.9-806a352e` | prod |
