> **⏱ Historical snapshot — audit of 2026-05-10 at HEAD `cf4c0ef`.**
> Superseded by the current report at `DEVPROOF-REPORT.md` (re-examined 2026-06-07 at HEAD `069a6c3`).
> Findings F1–F6 below are as-written on the original date; see `FOLLOWUP-REPORT.md` for the per-finding
> re-examination and the current report for net status.
